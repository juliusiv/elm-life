...
var _JuliusAlexanderIV$elm_life$Styles$darkBlue = '#596277';
var _JuliusAlexanderIV$elm_life$Styles$yellow = '#EEAC00';
var _JuliusAlexanderIV$elm_life$Styles$green = '#7ED039';
var _JuliusAlexanderIV$elm_life$Styles$buttonGreen = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: _JuliusAlexanderIV$elm_life$Styles$green}
		]));
var _JuliusAlexanderIV$elm_life$Styles$blue = '#60B5CC';
var _JuliusAlexanderIV$elm_life$Styles$cell = F2(
	function (size, alive) {
		var dim = A2(
			F2(
				function (x, y) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _JuliusAlexanderIV$elm_life$Main$main === 'undefined' ? null : _JuliusAlexanderIV$elm_life$Main$main);
